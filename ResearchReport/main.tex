...
He decided to verify 5 different topological conditions over the configurations of Voronoi tiles : 
\begin{itemize}
...
Those conditions are verified at every step of the relaxation.
...
For this we will use the border that was defined at the beginning. We define a 
